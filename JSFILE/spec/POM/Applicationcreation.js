...
describe('TS_001 - application  creation ', function () {
    var sleep = 3000;
    ...
    it('TC_003: application creation for IA', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    ...
                    return [4 /*yield*/, Appcreate.connectionoption1.click()];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, Appcreate.connectionprofile.click()];
                case 3:
                    _a.sent();
                    return [4 /*yield*/, Appcreate.profileoption1.click()];
                case 4:
                    _a.sent();

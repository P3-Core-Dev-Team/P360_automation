        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, Connection.connectiontype.click()];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, Connection.connectionoption2.click()];
                case 2:
                    _a.sent();
                    protractor_1.browser.sleep(5000);
                    return [4 /*yield*/, Connection.RDBMStype.click()];
                case 3:
                    _a.sent();
                    protractor_1.browser.sleep(3000);
                    ...
                    //  browser.sleep(4000);
                    //MySQl Connection 
                    return [4 /*yield*/, Connection.RDBMStype1.click()];
                case 4:
                    //  postgresql connection  details 
                    //  await Connection.RDBMStype2.click();
                    //  Connection.profilename.sendKeys(x.readExcel("testdata.xlsx", "Sheet1", 24, 1));
                ...
                case 8:
                    _a.sent();
                    protractor_1.browser.sleep(5000);
                    return [4 /*yield*/, Connection.Searchconnection.sendKeys("MYSQL_PROFILE")];
                case 9:
                    _a.sent();
                    return [2 /*return*/];
            }
